...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This app is a student management app 
        where you can register, edit, delete 
        students' information through a GUI.
        It is subject to changes to come.
...
class EditDialog(QDialog):
    def __init__(self):
        ...
        # Get the ID from a selected row
